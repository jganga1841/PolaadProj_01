...
var MdPaginationRange = (function (_super) {
    ...
    function MdPaginationRange(service, sanitizationService) {
        ...
        _this.sanitizationService = sanitizationService;
        _this.mdPaginationRange = true;
        _this.name = 'default';
        _this.model = {
            currentPage: 0,
            itemsPerPage: 0,
...
var MdPaginationControls = (function (_super) {
    ...
    function MdPaginationControls(service) {
        var _this = _super.call(this, service) || this;
        _this.service = service;
        _this.mdPaginationControls = true;
        _this.name = 'default';
        _this.model = {
            currentPage: 0,
            itemsPerPage: 0,
...
var MdPaginationItemsPerPage = (function (_super) {
    ...
    function MdPaginationItemsPerPage(service) {
        var _this = _super.call(this, service) || this;
        _this.service = service;
        _this.mdPaginationItemsPerPage = true;
        _this.name = 'default';
        _this.model = {
            currentPage: 0,
            itemsPerPage: 0,
        ...
        _this.itemsPerPageBefore = 'Rows per page:';
